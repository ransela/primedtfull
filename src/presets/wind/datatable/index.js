  ...
  column: {
    ...
    filterrowitem: ({ context }) => ({
          class: [
            ...
            "sm:text-sm",
            "leading-none",
            { "font-normal": !(context != null && context.highlighted), "font-bold": context == null ? void 0 : context.highlighted },
            // Position
            "relative",
            // Shape
            "border-0",
            ...
            { "bg-primary-500 dark:bg-primary-400 text-white dark:text-surface-700": context == null ? void 0 : context.highlighted },
            //States
